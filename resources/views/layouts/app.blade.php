...
<head>
    ...
    <!-- Bootstrap 5 CSS (Fallback for Layout) -->
    ...
    <!-- Scripts & Vite (Otomatis mendeteksi asset di Railway) -->
    ...
    <style>
        ...
        .nav-item:hover { background-color: #ffffff !important; color: #2563eb !important; } 
        .nav-item.active { background-color: #ffffff !important; color: #2563eb !important; font-weight: bold; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); }
    </style>
</head>
            ...
            <aside 
                ...
                <div class="p-4 border-t border-blue-500 flex-shrink-0 bg-blue-700">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="nav-item flex items-center w-full py-2 rounded-xl hover:bg-red-500 transition-colors" :class="sidebarOpen ? 'px-4' : 'justify-center'">
                ...
                <header class="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-8 shadow-sm z-40 sticky top-0">
                    <div class="flex items-center gap-6 flex-1">
                        ...
                        @if (isset($header))
                            ...
                            <div class="flex-1 font-semibold text-slate-700 truncate">
                                {{ $header }}
                            </div>
                        @endif
                    </div>
                            ...
                            @auth
                                ...
                                <div x-show="userMenuOpen" 
                                    ...
                                    <div class="px-2">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" class="flex items-center w-full px-4 py-2.5 text-sm text-red-500 hover:bg-red-50 rounded-lg transition-colors font-bold text-left">
